...
public class Variable {
	...
	public static void main(String[] args) {		
		 ...
		 *  - [여러 단어로 이루어진 경우 단어의 처 글자를 대문자로 한다.(상수는 언더바로 구분)]
		 *  - [클래스명의 첫글자는 대문자로 한다.]
		 *  - [패키지명은 모두 소문자로 한다.]
		 */
...
/*		System.out.println("숫자를 입력하세요>");
		...
		String input = scan.nextLine();
		System.out.println("입력받은 문자는 "+input);
		
		//숫자를 입력받고 입력받은 숫자를 출력해주세요.
		System.out.println("숫자를 입력하시오");
		int input1 = Integer.parseInt(scan.nextLine());
		System.out.println("입력받은 숫자는" + input1);
	...
	/*	String id;
		...
		System.out.println("입력하신 아이디 " +id+" 비밀번호 " +password+ " 이름 " + name + " 전화번호 "+ tel+" 이메일 "+email+"입니다." );*/
